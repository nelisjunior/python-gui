...
def generate_urls(output_folder_path=None):
    ...
    # Criar o nome do arquivo de saída com a data atual
...
# Criação dos checkboxes para os servidores disponíveis
...
pasta_aplicacao_opts = ["sintese", "suibe"]
